...
export const miniGames: MiniGame[] = [
  {
    ...
    description: 'จับคู่ดาวเคราะห์กับข้อเท็จจริงที่ถูกต้อง เกมที่ทดสอบความจำและความรู้',
    thumbnail: '🪐',
    difficulty: 'Easy',
    category: 'Memory',
  ...
  },
  {
    ...
    description: 'ทดสอบความรู้เกี่ยวกับระบบสุริยะ ดาวเคราะห์ และปรากฏการณ์ทางดาราศาสตร์',
    thumbnail: '☀️',
    difficulty: 'Medium',
    category: 'Knowledge',
  ...
  },
  {
    id: 'space-memory',
    title: 'เกมจำภาพอวกาศ',
    description: 'จำตำแหน่งของวัตถุท้องฟ้าต่างๆ ทดสอบความสามารถในการจดจำ',
    thumbnail: '🌌',
    difficulty: 'Hard',
    category: 'Memory',
  ...
  },
  {
    ...
    description: 'เรียงลำดับดาวเคราะห์จากใกล้ดวงอาทิตย์ เกมปริศนาที่สนุกและท้าทาย',
    thumbnail: '🌍',
    difficulty: 'Easy',
    category: 'Puzzle',
  ...
  },
  {
    ...
    title: 'เชื่อมดาวกลุ่มดาว',
    description: 'เชื่อมจุดเพื่อสร้างรูปกลุ่มดาวที่สวยงาม ฝึกทักษะการจดจำรูปแบบ',
    thumbnail: '⭐',
    difficulty: 'Medium',
    category: 'Puzzle',
  ...
  {
    id: 'asteroid-dodge',
    title: 'หลบหลีกดาวเคราะห์น้อย',
    description: 'ควบคุมยานอวกาศหลบหลีกดาวเคราะห์น้อย เกมแอ็กชันที่เร้าใจ',
    thumbnail: '🚀',
    difficulty: 'Hard',
    category: 'Action',
  ...
  {
    id: 'galaxy-explorer',
    title: 'สำรวจกาแล็กซี่',
    description: 'เดินทางข้ามกาแล็กซี่เพื่อค้นหาดาวเคราะห์ใหม่ และชีวิตนอกโลก',
    thumbnail: '🌠',
    difficulty: 'Medium',
    category: 'Knowledge',
  ...
  },
  {
    ...
    title: 'หนีหลุมดำ',
    description: 'ใช้ฟิสิกส์และเคล็ดลับเพื่อหนีจากแรงดึงดูดของหลุมดำที่น่ากลัว',
    thumbnail: '🕳️',
    difficulty: 'Hard',
    category: 'Action',
