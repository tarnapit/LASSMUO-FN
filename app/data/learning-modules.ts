...
export const learningModules: LearningModule[] = [
  {
    ...
    title: "Solar System",
    description:
      "Planets in our universe we call Solar System and it is base knowledge of astronomy",
    level: "Fundamental",
        ...
        content: [
          {
            type: "text",
            content:
              " กำเนิดระบบสุริยะและการแบ่งเขตบริวารรอบดวงอาทิตย์ เมื่อลืมตาจากการนอนหลับ แสงธรรมชาติเป็นสิ่งสำคัญที่ทำให้คุณมองเห็นสิ่งต่าง ๆ รอบตัวได้ หลายคนอาจลืมไปว่าแหล่งกำเนิดของแสงเหล่านี้ มาจากดวงอาทิตย์ซึ่งอยู่ไกลแสนไกลจากโลกของเรา ดังนั้นการเข้าใจการกำเนิดของระบบสุริยะ และการศึกษาองค์ประกอบของระบบสุริยะ จึงเป็นเสมือนการศึกษาและทำความเข้าใจแหล่งพลังงานสำคัญของมนุษยชาตินั่นเอง ซึ่งในบทเรียนนี้จะกล่าวถึงกำเนิดระบบสุริยะ องค์ประกอบของระบบสุริยะ และการแบ่งเขตบริวารรอบดวงอาทิตย์",
          },
          {
            type: "image",
          ...
          },
          {
            ...
            activity: {
              ...
              data: {
                ...
                correctAnswer: 1,
                explanation:
                  "ระบบสุริยะมีดาวเคราะห์ทั้งหมด 8 ดวง หลังจากที่ดาวพลูโตถูกจัดประเภทเป็นดาวเคราะห์แคระในปี 2006",
              },
              points: 10,
              feedback: {
                correct:
                  "เยี่ยม! คุณจำได้ถูกต้องว่าระบบสุริยะมีดาวเคราะห์ 8 ดวง",
                incorrect:
                  "ไม่ถูกต้อง ระบบสุริยะมีดาวเคราะห์ 8 ดวง หลังจากที่ดาวพลูโตถูกจัดเป็นดาวเคราะห์แคระ",
          ...
          },
          {
            type: "text",
            content:
              "ดาวอาทิตย์เป็นดาวฤกษ์ที่อยู่ใจกลางของระบบสุริยะ มีมวลมากที่สุดในระบบ คิดเป็นประมาณ 99.86% ของมวลทั้งหมดในระบบสุริยะ",
          },
          {
            type: "fill-blanks",
            ...
            activity: {
              ...
              data: {
                sentence:
                  "ดาวอาทิตย์เป็น {blank} ที่อยู่ใจกลางของระบบสุริยะ และมีมวลคิดเป็นประมาณ {blank} ของมวลทั้งหมดในระบบ",
                options: [
                  "ดาวฤกษ์",
                  "ดาวเคราะห์",
                  "99.86%",
              ...
              feedback: {
                correct:
                  "ถูกต้อง! ดาวอาทิตย์เป็นดาวฤกษ์และมีมวลมากถึง 99.86% ของระบบ",
                incorrect:
                  "ลองใหม่อีกครั้ง คิดถึงประเภทของดาวอาทิตย์และสัดส่วนมวลของมัน",
        ...
        content: [
          {
            type: "text",
            content:
              "ในระบบสุริยะมีดาวเคราะห์ทั้งหมด 8 ดวง แบ่งออกเป็น 2 กลุ่มหลัก คือ ดาวเคราะห์ในระบบภายใน (Inner Planets) และดาวเคราะห์ในระบบภายนอก (Outer Planets)",
          },
          {
            type: "matching",
            ...
            activity: {
                ...
                pairs: [
                  {
                    ...
                    explanation:
                      "ดาวพุธอยู่ใกล้ดวงอาทิตย์ที่สุด ห่างเพียง 58 ล้านกิโลเมตร",
                  },
                  {
                    left: "ดาวศุกร์",
                    right: "ร้อนที่สุดในระบบสุริยะ",
                    explanation:
                      "ดาวศุกร์ร้อนที่สุดเนื่องจากมีชั้นบรรยากาศหนาทึบ",
                  },
                  {
                    left: "โลก",
                    right: "มีสิ่งมีชีวิตอาศัยอยู่",
                    explanation:
                      "โลกเป็นดาวเคราะห์เดียวที่ทราบว่ามีสิ่งมีชีวิต",
                  },
                  {
                    left: "ดาวอังคาร",
                    right: "มีสีแดงจากสนิมเหล็ก",
                    explanation:
                      "ดาวอังคารมีสีแดงเพราะพื้นผิวมีสนิมเหล็ก (Iron Oxide)",
                  },
                ],
              },
              points: 20,
              feedback: {
                correct:
                  "เยี่ยมมาก! คุณจับคู่ดาวเคราะห์กับคุณสมบัติได้ถูกต้องทั้งหมด",
                incorrect:
                  "ลองดูใหม่อีกครั้ง คิดถึงคุณสมบัติเด่นของแต่ละดาวเคราะห์",
          ...
          },
          {
            type: "text",
            content:
              "ดาวเคราะห์ในระบบภายใน ได้แก่ ดาวพุธ ดาวศุกร์ โลก และดาวอังคาร ซึ่งเป็นดาวเคราะห์หิน",
          },
          {
            type: "image",
          ...
          },
          {
            ...
            activity: {
              ...
              type: "sentence-ordering",
              instruction:
                "เรียงลำดับดาวเคราะห์ภายในจากใกล้ดวงอาทิตย์ที่สุดไปไกลที่สุด",
              difficulty: "hard",
              maxAttempts: 2,
              passingScore: 12,
              timeLimit: 60,
              ...
              feedback: {
                correct:
                  "ถูกต้อง! ลำดับดาวเคราะห์ภายในคือ พุธ ศุกร์ โลก อังคาร",
          ...
          },
          {
            type: "text",
            content:
              "ดาวเคราะห์ในระบบภายนอก ได้แก่ ดาวพฤหัสบดี ดาวเสาร์ ดาวยูเรนัส และดาวเนปจูน ซึ่งเป็นดาวเคราะห์แก๊ส",
          },
          {
            type: "true-false",
            ...
            activity: {
              ...
              data: {
                statement:
                  "ดาวพฤหัสบดีเป็นดาวเคราะห์ที่ใหญ่ที่สุดในระบบสุริยะและมีแรงโน้มถ่วงมากกว่าโลกหลายเท่า",
                correctAnswer: true,
                explanation:
                  "ถูกต้อง! ดาวพฤหัสบดีเป็นดาวเคราะห์ที่ใหญ่ที่สุด มีมวลมากกว่าดาวเคราะห์อื่นๆ รวมกัน และแรงโน้มถ่วงมากกว่าโลกประมาณ 2.5 เท่า",
              },
              points: 10,
              feedback: {
                correct: "ถูกต้อง! ดาวพฤหัสบดีใหญ่และหนักมากจริงๆ",
                incorrect:
                  "ไม่ถูกต้อง ดาวพฤหัสบดีเป็นดาวเคราะห์ที่ใหญ่ที่สุดในระบบสุริยะ",
          ...
          },
          {
            ...
            activity: {
              ...
              type: "sentence-ordering",
              instruction:
                "จัดเรียงดาวเคราะห์ตามรอบการโคจร (จากเร็วที่สุดไปช้าที่สุด)",
              difficulty: "hard",
              maxAttempts: 2,
              passingScore: 18,
              timeLimit: 90,
              data: {
                instruction:
                  "เรียงดาวเคราะห์ตามความเร็วในการโคจรรอบดวงอาทิตย์ (เร็วที่สุดไปช้าที่สุด)",
                sentences: [
                  "ดาวพุธ (88 วัน)",
                  "ดาวศุกร์ (225 วัน)",
                  "โลก (365 วัน)",
                ...
                explanation:
                  "ดาวเคราะห์ที่ใกล้ดวงอาทิตย์มากจะโคจรเร็วกว่า ตามกฎของเคปเลอร์",
              },
              points: 20,
              feedback: {
                correct: "ยอดเยี่ยม! คุณเข้าใจหลักการโคจรของดาวเคราะห์แล้ว",
                incorrect:
                  "ลองใหม่ ดาวที่ใกล้ดวงอาทิตย์จะโคจรเร็วกว่าดาวที่ไกล",
          ...
          },
          {
            ...
            activity: {
              ...
              data: {
                sentence:
                  "เมื่อดวงอาทิตย์มีการระเบิด {blank} จะส่งผลต่อ {blank} ของโลก และอาจทำให้เกิด {blank} ที่ขั้วโลก",
                options: [
                  "พายุแม่เหล็กสุริยะ",
                  "พายุฝน",
                  "สนามแม่เหล็ก",
                ...
                explanation:
                  "พายุแม่เหล็กสุริยะส่งอนุภาคพลังงานสูงมายังโลก กระทบสนามแม่เหล็กโลก และสร้างแสงเหนือ (Aurora) ที่สวยงาม",
              },
              points: 18,
              feedback: {
                correct: "สุดยอด! คุณเข้าใจปรากฏการณ์อวกาศได้ดีมาก",
                incorrect:
                  "ลองใหม่ คิดถึงปรากฏการณ์ที่เกิดจากดวงอาทิตย์และส่งผลต่อโลก",
        ...
        content: [
          {
            type: "text",
            content:
              "แต่ละดาวเคราะห์มีคุณสมบัติพิเศษที่แตกต่างกัน เช่น ดาวเสาร์มีวงแหวน ดาวพฤหัสบดีมีจุดแดงใหญ่ และดาวยูเรนัสหมุนตะแคงข้าง",
          },
          {
            ...
            activity: {
              ...
              data: {
                ...
                correctAnswer: 1,
                explanation:
                  "ดาวเสาร์เป็นดาวเคราะห์ที่มีวงแหวนที่เห็นได้ชัดเจนและสวยงามที่สุด",
              },
              points: 15,
              feedback: {
                correct: "ถูกต้อง! ดาวเสาร์มีวงแหวนที่สวยงามและโดดเด่นที่สุด",
                incorrect:
                  "ไม่ถูกต้อง วงแหวนที่เห็นได้ชัดเจนนี้เป็นของดาวเสาร์",
          ...
          },
          {
            ...
            activity: {
              ...
              feedback: {
                ...
                incorrect:
                  "ไม่ถูกต้อง โลกมีเส้นผ่านศูนย์กลางประมาณ 12,742 กิโลเมตร",
              },
            },
          },
          {
            type: "text",
            content:
              "ดาวเคราะห์แต่ละดวงมีขนาดและระยะห่างจากดวงอาทิตย์ที่แตกต่างกัน ซึ่งส่งผลต่ออุณหภูมิและสภาพแวดล้อมของแต่ละดาว",
          },
          {
            type: "multiple-choice",
            ...
            activity: {
              ...
              type: "multiple-choice",
              instruction:
                "หากคุณมียานอวกาศไปเยี่ยมชมดาวเคราะห์ได้ 1 ดวง คุณจะเลือกดาวไหนและทำไม?",
              difficulty: "medium",
              maxAttempts: 1,
              passingScore: 15,
              timeLimit: 90,
              data: {
                ...
                correctAnswer: 0,
                explanation:
                  "ดาวอังคารเป็นเป้าหมายหลักของการสำรวจอวกาศ เพราะมีสภาพแวดล้อมที่เคยเหมาะสมกับสิ่งมีชีวิต และอาจมีน้ำแข็งใต้ผิวดิน",
              },
              points: 15,
              feedback: {
                correct:
                  "ตัวเลือกที่ดีเยี่ยม! ดาวอังคารเป็นจุดหมายที่น่าสนใจที่สุดสำหรับมนุษย์",
                incorrect:
                  "ทุกตัวเลือกน่าสนใจ! แต่ดาวอังคารเป็นเป้าหมายหลักเพราะมีความเป็นไปได้ของสิ่งมีชีวิต",
          ...
          },
          {
            ...
            activity: {
                ...
                pairs: [
                  {
                    ...
                    explanation:
                      "ดาวพฤหัสบดีมีเส้นผ่านศูนย์กลางใหญ่กว่าโลกประมาณ 11 เท่า และมีมวลมากกว่าดาวเคราะห์อื่นรวมกัน",
                  },
                  {
                    left: "ดาวเสาร์",
                    right: "ใหญ่กว่าโลก 9 เท่า แต่น้ำหนักเบากว่าน้ำ",
                    explanation:
                      "ดาวเสาร์มีความหนาแน่นต่ำมาก หากมีมหาสมุทรใหญ่พอ ดาวเสาร์จะลอยน้ำได้",
                  },
                  {
                    left: "ดาวพุธ",
                    right: "เล็กกว่าโลก 2.6 เท่า",
                    explanation:
                      "ดาวพุธเป็นดาวเคราะห์ที่เล็กที่สุด มีขนาดเพียงประมาณ 38% ของโลก",
                  },
                  {
                    left: "ดาวยูเรนัส",
                    right: "ใหญ่กว่าโลก 4 เท่า และหมุนตะแคงข้าง",
                    explanation:
                      "ดาวยูเรนัสมีขนาดใหญ่กว่าโลก 4 เท่า และมีแกนหมุนเอียงเกือบ 90 องศา",
                  },
                ],
              },
              points: 25,
              feedback: {
                correct:
                  "สุดยอด! คุณเข้าใจขนาดและสัดส่วนของดาวเคราะห์เป็นอย่างดี",
                incorrect:
                  "ลองใหม่อีกครั้ง ดูข้อมูลเปรียบเทียบขนาดให้ละเอียดยิ่งขึ้น",
  ...
  },
  {
    ...
    description:
      'In our planet that call "Earth" have structure that we going to find out',
    level: "Fundamental",
        ...
        content: [
          {
            type: "text",
            content:
              "โลกของเรามีโครงสร้างภายในที่แบ่งออกเป็น 4 ชั้นหลัก คือ เปลือกโลก เนื้อโลก แกนกลางชั้นนอก และแกนกลางชั้นใน",
          },
          {
            type: "image",
          ...
          },
          {
            ...
            activity: {
              ...
              feedback: {
                correct:
                  "ถูกต้อง! ลำดับชั้นโลกคือ เปลือกโลก เนื้อโลก แกนกลางชั้นนอก แกนกลางชั้นใน",
                incorrect:
                  "ไม่ถูกต้อง ลองคิดถึงการเรียงลำดับจากชั้นนอกไปชั้นในอีกครั้ง",
          ...
          },
          {
            type: "text",
            content:
              "เปลือกโลกมีความหนาประมาณ 5-70 กิโลเมตร เนื้อโลกมีความหนาประมาณ 2,900 กิโลเมตร และแกนกลางมีรัศมีประมาณ 3,500 กิโลเมตร",
          },
          {
            type: "multiple-choice",
            ...
            activity: {
              ...
              data: {
                ...
                correctAnswer: 1,
                explanation:
                  "แผ่นดินไหวส่วนใหญ่เกิดจากการเคลื่อนที่และการชนกันของแผ่นเปลือกโลก (Tectonic Plates) ที่รอยต่อของแผ่น",
              },
              points: 18,
              feedback: {
                correct:
                  "ถูกต้อง! การเคลื่อนที่ของแผ่นเปลือกโลกเป็นสาเหตุหลักของแผ่นดินไหว",
                incorrect:
                  "ไม่ถูกต้อง แผ่นดินไหวเกิดจากการเคลื่อนที่ของแผ่นเปลือกโลก",
          ...
          },
          {
            ...
            activity: {
              ...
              data: {
                sentence:
                  "หินอัคนีเกิดจาก {blank} ที่เย็นตัว หินตะกอนเกิดจากการ {blank} และ {blank} ส่วนหินแปรเกิดจากความ {blank} และแรงกดสูง",
                options: [
                  "แมกมา",
                  "น้ำ",
                  "กัดเซาะ",
                ...
                explanation:
                  "วัฏจักรหิน: หินอัคนี (แมกมาเย็นตัว) → หินตะกอน (กัดเซาะ+ตกทับถม) → หินแปร (ความร้อน+แรงกด)",
              },
              points: 20,
              feedback: {
          ...
          },
          {
            ...
            activity: {
              ...
              data: {
                ...
                unit: "องศาเซลเซียส",
                explanation:
                  "แกนกลางโลกมีอุณหภูมิประมาณ 5,500°C ร้อนพอๆ กับผิวดวงอาทิตย์!",
              },
              points: 25,
              feedback: {
        ...
        content: [
          {
            type: "text",
            content:
              "ชั้นบรรยากาศของโลกแบ่งออกเป็น 5 ชั้น คือ โทรโปสเฟียร์ สตราโตสเฟียร์ มีโซสเฟียร์ เทอร์โมสเฟียร์ และเอ็กโซสเฟียร์",
          },
          {
            type: "multiple-choice",
            ...
            activity: {
              ...
              data: {
                ...
                correctAnswer: 1,
                explanation:
                  "สตราโตสเฟียร์มีชั้นโอโซนที่ปกป้องโลกจากรังสียูวีอันตราย",
              },
              points: 10,
              feedback: {
          ...
          },
          {
            type: "text",
            content:
              "ชั้นบรรยากาศแต่ละชั้นมีคุณสมบัติและหน้าที่ที่แตกต่างกัน เช่น โทรโปสเฟียร์เป็นที่เกิดสภาพอากาศ สตราโตสเฟียร์มีชั้นโอโซน",
          },
          {
            type: "matching",
            ...
            activity: {
                ...
                pairs: [
                  {
                    ...
                    explanation:
                      "โทรโปสเฟียร์เป็นชั้นล่างสุดที่มนุษย์อาศัยอยู่ มีการเกิดเมฆ ฝน และปรากฏการณ์อากาศต่างๆ",
                  },
                  {
                    left: "สตราโตสเฟียร์",
                    right: "มีชั้นโอโซนปกป้องจากรังสี UV",
                    explanation:
                      "สตราโตสเฟียร์มีชั้นโอโซนที่ดูดซับรังสียูวีจากดวงอาทิตย์ ปกป้องสิ่งมีชีวิตบนโลก",
                  },
                  {
                    left: "มีโซสเฟียร์",
                    right: "เย็นที่สุด อุกกาบาตไหม้หมดที่นี่",
                    explanation:
                      "มีโซสเฟียร์เป็นชั้นที่เย็นที่สุด อุกกาบาตส่วนใหญ่จะไหม้หมดในชั้นนี้",
                  },
                  {
                    left: "เทอร์โมสเฟียร์",
                    right: "ร้อนมาก มีแสงเหนือเกิดขึ้น",
                    explanation:
                      "เทอร์โมสเฟียร์มีอุณหภูมิสูงมาก และเป็นชั้นที่เกิดแสงเหนือ (Aurora)",
                  },
                ],
              },
              points: 22,
              feedback: {
                correct:
                  "ยอดเยี่ยม! คุณเข้าใจชั้นบรรยากาศทั้ง 4 ชั้นเป็นอย่างดี",
          ...
          },
          {
            ...
            activity: {
              ...
              data: {
                statement:
                  "ฟ้าร้องฟ้าผ่าเกิดขึ้นในชั้นโทรโปสเฟียร์ และเป็นการคายประจุไฟฟ้าจากเมฆมายังพื้นดิน",
                correctAnswer: true,
                explanation:
                  "ถูกต้อง! ฟ้าร้องฟ้าผ่าเกิดในโทรโปสเฟียร์ เป็นการคายประจุไฟฟ้าสถิตที่สะสมในเมฆ",
              },
              points: 12,
              feedback: {
                correct: "ถูกต้อง! ฟ้าผ่าเป็นปรากฏการณ์ไฟฟ้าธรรมชาติ",
                incorrect:
                  "ไม่ถูกต้อง ฟ้าผ่าเกิดจากการคายประจุไฟฟ้าในโทรโปสเฟียร์",
          ...
          },
          {
            ...
            activity: {
              ...
              data: {
                ...
                unit: "กิโลเมตร",
                explanation:
                  "ชั้นบรรยากาศโลกมีความสูงประมาณ 1,000 กิโลเมตร จนถึงอวกาศ",
              },
              points: 15,
              feedback: {
        ...
        content: [
          {
            type: "text",
            content:
              "สนามแม่เหล็กโลกเกิดจากการเคลื่อนไหวของเหล็กเหลวในแกนกลางชั้นนอก ทำหน้าที่ปกป้องโลกจากรังสีอันตรายจากอวกาศ",
          },
          {
            type: "fill-blanks",
            ...
            activity: {
              ...
              data: {
                sentence:
                  "สนามแม่เหล็กโลกเกิดจาก {blank} ที่เคลื่อนไหวในแกนกลางชั้นนอก และช่วยปกป้องโลกจาก {blank} จากอวกาศ",
                options: [
                  "เหล็กเหลว",
                  "หินหลอมเหลว",
                  "รังสีอันตราย",
              ...
              feedback: {
                correct:
                  "ถูกต้อง! เหล็กเหลวสร้างสนามแม่เหล็กที่ปกป้องเราจากรังสี",
                incorrect:
                  "ลองใหม่ คิดถึงสิ่งที่อยู่ในแกนกลางและสิ่งที่สนามแม่เหล็กปกป้อง",
          ...
          },
          {
            type: "text",
            content:
              "สนามแม่เหล็กโลกมีขั้วเหนือและขั้วใต้ ซึ่งไม่ตรงกับขั้วทางภูมิศาสตร์ และสามารถเปลี่ยนขั้วได้ในอนาคต",
          },
          {
            type: "multiple-choice",
            ...
            activity: {
              ...
              data: {
                ...
                correctAnswer: 1,
                explanation:
                  "เข็มทิศชี้ไปทางขั้วแม่เหล็กเหนือของโลก ซึ่งเกิดจากสนามแม่เหล็กโลก",
              },
              points: 18,
              feedback: {
          ...
          },
          {
            ...
            activity: {
              ...
              data: {
                statement:
                  "แสงเหนือ (Aurora) เกิดจากการที่อนุภาคจากดวงอาทิตย์ชนกับสนามแม่เหล็กโลกและก๊าซในบรรยากาศ",
                correctAnswer: true,
                explanation:
                  "ถูกต้อง! แสงเหนือเกิดจากลมสุริยะ (อนุภาคจากดวงอาทิตย์) ที่ถูกสนามแม่เหล็กโลกนำไปชนกับก๊าซในบรรยากาศที่ขั้วโลก",
              },
              points: 15,
              feedback: {
                correct: "ยอดเยี่ยม! คุณเข้าใจการเกิดแสงเหนือแล้ว",
                incorrect:
                  "ไม่ถูกต้อง แสงเหนือเกิดจากการปฏิสัมพันธ์ระหว่างลมสุริยะและสนามแม่เหล็ก",
          ...
          },
          {
            ...
            activity: {
              ...
              data: {
                image:
                  "รูปแบบเส้นสนามแม่เหล็กโลกที่ดูเหมือนวงรี ออกจากขั้วเหนือและเข้าที่ขั้วใต้",
                ...
                correctAnswer: 0,
                explanation:
                  "Magnetosphere คือบริเวณรอบโลกที่อยู่ภายใต้อิทธิพลของสนามแม่เหล็กโลก",
              },
              points: 20,
              feedback: {
                correct: "ถูกต้อง! Magnetosphere ปกป้องโลกจากรังสีอวกาศ",
                incorrect:
                  "ไม่ถูกต้อง บริเวณสนามแม่เหล็กรอบโลกเรียก Magnetosphere",
