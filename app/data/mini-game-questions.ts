...
export const matchingQuestions: MiniGameQuestion[] = [
  ...
  },
  {
    ...
    pairs: [
      ...
      { left: 'เสื้อคลุมโลก', right: 'ชั้นที่หนาที่สุดและเป็นหิน' },
    ...
    correctAnswer: [
      ...
      'เสื้อคลุมโลก-ชั้นที่หนาที่สุดและเป็นหิน',
...
export const orderingQuestions: MiniGameQuestion[] = [
  ...
  },
  {
    ...
    type: 'ordering',
    items: ['แกนกลางชั้นใน', 'เสื้อคลุมโลก', 'เปลือกโลก', 'แกนกลางชั้นนอก'],
    correctOrder: [2, 1, 3, 0], // เปลือกโลก, เสื้อคลุมโลก, แกนกลางชั้นนอก, แกนกลางชั้นใน
    correctAnswer: ['เปลือกโลก', 'เสื้อคลุมโลก', 'แกนกลางชั้นนอก', 'แกนกลางชั้นใน'],
    explanation: 'ลำดับชั้นโครงสร้างโลกจากนอกเข้าใน: เปลือกโลก, เสื้อคลุมโลก, แกนกลางชั้นนอก, แกนกลางชั้นใน',
    difficulty: 'hard',
    points: 22,
    category: 'earth-structure',
    timeBonus: 11
