...
-- Earth Structure Course Quizzes
('earth-quiz-001', 'jj1jj1dd-1f1f-1f8a-ff19-f8fff917ffa8', 'ทดสอบความรู้โครงสร้างโลก', 'multiple-choice', 'เลือกคำตอบที่ถูกต้องเกี่ยวกับชั้นโครงสร้างของโลก', 3, 15, 45, 'Medium', '{"options": ["2 ชั้น", "3 ชั้น", "4 ชั้น", "5 ชั้น"], "question": "โลกมีโครงสร้างภายในทั้งหมดกี่ชั้นหลัก?", "explanation": "โลกมีโครงสร้างภายใน 4 ชั้นหลัก คือ เปลือกโลก เนื้อโลก แกนกลางชั้นนอก และแกนกลางชั้นใน", "correctAnswer": 2}', 15, '{"hint": "นึกถึงโครงสร้างจากชั้นนอกสุดไปในสุด", "correct": "ถูกต้อง! โลกมีโครงสร้างภายใน 4 ชั้นหลัก", "incorrect": "ไม่ถูกต้อง โลกมีโครงสร้างภายใน 4 ชั้นหลัก"}', '2025-10-03 06:15:00.000', '2025-10-03 06:15:00.000'),
('earth-quiz-002', 'kk2kk2ee-2f2f-2f9b-ff2a-f9fff028ffb9', 'เติมคำเกี่ยวกับชั้นโลก', 'fill-blanks', 'เติมคำที่ถูกต้องเกี่ยวกับความหนาของชั้นโลก', 2, 20, 60, 'Hard', '{"sentence": "เปลือกโลกมีความหนาประมาณ {blank} กิโลเมตร และเนื้อโลกมีความหนาประมาณ {blank} กิโลเมตร", "options": ["5-70", "2,900", "3,500", "1,000", "500", "10,000"], "correctAnswers": ["5-70", "2,900"]}', 20, '{"correct": "ยอดเยี่ยม! คุณจำตัวเลขความหนาของชั้นโลกได้ถูกต้อง", "incorrect": "ลองใหม่อีกครั้ง เปลือกโลกบางที่สุด เนื้อโลกหนาที่สุด", "hint": "เปลือกโลกบางมาก เนื้อโลกเป็นชั้นที่หนาที่สุด"}', '2025-10-03 06:15:30.000', '2025-10-03 06:15:30.000'),
('earth-quiz-003', 'll3ll3ff-3f3f-3fac-ff3b-faff139ffca', 'จับคู่ชั้นบรรยากาศ', 'matching', 'จับคู่ชั้นบรรยากาศกับลักษณะเด่น', 3, 18, 90, 'Medium', '{"pairs": [{"left": "โทรโปสเฟียร์", "right": "ชั้นที่เราอาศัยอยู่", "explanation": "โทรโปสเฟียร์เป็นชั้นบรรยากาศที่ใกล้พื้นผิวโลกที่สุด"}, {"left": "สตราโตสเฟียร์", "right": "มีชั้นโอโซน", "explanation": "สตราโตสเฟียร์มีชั้นโอโซนที่ปกป้องโลกจากรังสี UV"}, {"left": "เทอร์โมสเฟียร์", "right": "ร้อนที่สุด", "explanation": "เทอร์โมสเฟียร์มีอุณหภูมิสูงที่สุดในบรรยากาศ"}, {"left": "เอ็กโซสเฟียร์", "right": "ชั้นนอกสุด", "explanation": "เอ็กโซสเฟียร์เป็นชั้นบรรยากาศชั้นนอกสุดที่ค่อยๆ ละลายเข้ากับอวกาศ"}]}', 25, '{"correct": "เยี่ยมมาก! คุณเข้าใจชั้นบรรยากาศแต่ละชั้นได้ดี", "incorrect": "ลองดูใหม่อีกครั้ง แต่ละชั้นมีคุณสมบัติพิเศษแตกต่างกัน", "hint": "โทรโปสเฟียร์ใกล้เรา สตราโตสเฟียร์มีโอโซน เทอร์โมสเฟียร์ร้อน เอ็กโซสเฟียร์นอกสุด"}', '2025-10-03 06:16:00.000', '2025-10-03 06:16:00.000'),
('earth-quiz-004', 'mm4mm4gg-4f4f-4fbd-ff4c-fbff24affdb', 'ถูกหรือผิด: บรรยากาศโลก', 'true-false', 'พิจารณาข้อความเกี่ยวกับชั้นบรรยากาศ', 2, 12, 30, 'Easy', '{"statement": "โทรโปสเฟียร์เป็นชั้นบรรยากาศที่เกิดสภาพอากาศและเป็นที่อาศัยของมนุษย์", "correctAnswer": true, "explanation": "ถูกต้อง! โทรโปสเฟียร์เป็นชั้นบรรยากาศที่ใกล้พื้นผิวโลกที่สุด เป็นที่เกิดสภาพอากาศ และเป็นที่อาศัยของสิ่งมีชีวิตบนโลก"}', 12, '{"correct": "ถูกต้อง! โทรโปสเฟียร์เป็นชั้นบรรยากาศสำคัญสำหรับชีวิต", "incorrect": "ไม่ถูกต้อง โทรโปสเฟียร์เป็นชั้นที่เราอาศัยอยู่จริงๆ", "hint": "ชั้นบรรยากาศที่เราหายใจอากาศอยู่ทุกวัน"}', '2025-10-03 06:16:30.000', '2025-10-03 06:16:30.000'),
('earth-quiz-005', 'nn5nn5hh-5f5f-5fce-ff5d-fcff35bffec', 'เรียงลำดับสนามแม่เหล็ก', 'sentence-ordering', 'เรียงลำดับกระบวนการเกิดสนามแม่เหล็กโลก', 2, 16, 75, 'Hard', '{"instruction": "เรียงลำดับกระบวนการเกิดสนามแม่เหล็กโลก", "sentences": ["เหล็กเหลวในแกนกลางชั้นนอกเคลื่อนไหว", "เกิดกระแสไฟฟ้า", "สร้างสนามแม่เหล็ก", "ปกป้องโลกจากรังสีอันตราย"], "correctOrder": [0, 1, 2, 3]}', 20, '{"correct": "สุดยอด! คุณเข้าใจกระบวนการเกิดสนามแม่เหล็กโลกได้ดี", "incorrect": "ลองใหม่อีกครั้ง เริ่มจากการเคลื่อนไหวของเหล็กเหลว", "hint": "เริ่มจากแกนกลางที่มีเหล็กเหลวเคลื่อนไหว → เกิดกระแส → สนามแม่เหล็ก → ปกป้อง"}', '2025-10-03 06:17:00.000', '2025-10-03 06:17:00.000'),
('earth-quiz-006', 'oo6oo6ii-6f6f-6fdf-ff6e-fdff46cfffd', 'ขั้วแม่เหล็กโลก', 'multiple-choice', 'เลือกคำตอบที่ถูกต้องเกี่ยวกับขั้วแม่เหล็กโลก', 3, 14, 40, 'Medium', '{"options": ["ตรงกับขั้วทางภูมิศาสตร์เสมอ", "ไม่ตรงกับขั้วทางภูมิศาสตร์", "ไม่เคยเปลี่ยนตำแหน่ง", "มีเพียง 1 ขั้ว"], "question": "ข้อใดถูกต้องเกี่ยวกับขั้วแม่เหล็กโลก?", "explanation": "ขั้วแม่เหล็กโลกไม่ตรงกับขั้วทางภูมิศาสตร์ และสามารถเปลี่ยนขั้วได้ในอนาคต", "correctAnswer": 1}', 15, '{"hint": "ขั้วแม่เหล็กและขั้วภูมิศาสตร์ไม่ใช่สิ่งเดียวกัน", "correct": "ถูกต้อง! ขั้วแม่เหล็กโลกไม่ตรงกับขั้วทางภูมิศาสตร์", "incorrect": "ไม่ถูกต้อง ขั้วแม่เหล็กและขั้วภูมิศาสตร์ไม่ตรงกัน"}', '2025-10-03 06:17:30.000', '2025-10-03 06:17:30.000')
;
